  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>List an item</h2>
        <p>
          First time listing on Bonzos? <a>Read our sellers' guide.</a>
        </p>
      </Row>
  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with The Bonzos NFT...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on The Bonzos, check it out!",
      url: `${
        window.location.origin
      }/#/auction/${props.auction?.auction.toString()}`,
      hashtags: 'NFT,Crypto,Bonzos',
      // via: "Metaplex",
      related: 'Bonzos,Solana',
    };
